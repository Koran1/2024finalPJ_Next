...
import { Close, CloseSharp, Delete } from '@mui/icons-material';
...
function Page(props) {
    ...
    const handleModalClick = (comment, modal) => {
    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <div>
                        <h4 style={{textAlign: "center"}}>삭제 하시겠습니까?</h4>
                        <div style={{marginTop:"30px", textAlign:"right", display:"flex", justifyContent: "space-around"}}>
                            <Button
                                variant='contained'
                                color='error'
                                onClick={() => commentDelete(selectedComment)}
                                style={{width: "100px"}}
                            >삭제</Button>
                            <Button
                                variant='contained'
